...
# from pyspedas.tplot_tools import timespan
...
plt.plot(bins,dBmag_count,label='Magnetic Magnitude structures')
plt.plot(bins,dvmag_count,label='Velocity Magnitude structures')
plt.plot(bins,dn_count,label='Density structures')
plt.legend()
plt.yscale('log')
# %%'
...
plt.bar(bins, dBx_count, width=bin_width, edgecolor='black', align='edge', 
alpha=0.3, label='dBx structures', color='b')
plt.bar(bins, dBy_count, width=bin_width, edgecolor='black', 
align='edge', alpha=0.2, label='dBy structures', color='r')
plt.bar(bins, dBz_count, width=bin_width, edgecolor='black', 
...
#Line plot version
plt.plot(bins,dBx_count,label='Bx structures')
plt.plot(bins,dBy_count,label='By structures')
plt.plot(bins,dBz_count,label='Bz structures')
plt.legend()
plt.yscale('log')
# %%
...
bin_width = bins[1] - bins[0] if len(bins) > 1 else 25
plt.figure(figsize=(10, 6))
plt.bar(bins, dVx_count, width=bin_width, edgecolor='black', align='edge', 
alpha=0.7, label='dVx structures', color='b')
plt.bar(bins, dVy_count, width=bin_width, edgecolor='black', align='edge', 
alpha=0.5, label='dVy structures', color='r')
plt.bar(bins, dVz_count, width=bin_width, edgecolor='black', 
align='edge', alpha=0.3, label='dVz structures', color='g')
plt.xlabel(r'Scale Size $(R_e)$')
plt.ylabel('Count')
plt.yscale('log')
plt.legend()
...
#Line plot version
plt.plot(bins,dVx_count,label='Vx structures')
plt.plot(bins,dVy_count,label='Vy structures')
plt.plot(bins,dVz_count,label='Vz structures')
plt.legend()
plt.yscale('log')
