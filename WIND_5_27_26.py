...
plt.scatter(Bscal_0, Bscal_0, color='r', label='Reference Line')
...
dvx_0 = velocity_deltas[0,:,0]  #Timescale 0, X-component
dvy_0 = velocity_deltas[0,:,1]  
dvz_0 = velocity_deltas[0,:,2]  

mask0x = (dvx_0 >= 0.1) & (dni_0 >= 0.1)
mask0y = (dvy_0 >= 0.1) & (dni_0 >= 0.1)
mask0z = (dvz_0 >= 0.1) & (dni_0 >= 0.1)


new_Filtered_dvx_0 = dvx_0[mask0x]
new_Filtered_dvy_0 = dvy_0[mask0y]
new_Filtered_dvz_0 = dvz_0[mask0z]
...
mask1y = (dvy_1 >= 0.1) & (dni_1 >= 0.1)
mask1z = (dvz_1 >= 0.1) & (dni_1 >= 0.1)
...
new_Filtered_dvx_1 = dvx_1[mask]
new_Filtered_dvy_1 = dvy_1[mask]
new_Filtered_dvz_1 = dvz_1[mask]



plt.scatter(new_Filtered_dvx_0, new_Filtered_dvy_0 , s=10, color='b', label='Timescale 0')
plt.yscale('log')
plt.xscale('log')
# plt.scatter(new_Filtered_dvx_1, new_Filtered_dvy_1, s=10, color='k', label='Timescale 1')
# plt.plot(Bscal_0, Bscal_0, color='r', label='Reference Line')

plt.xlabel(r'$\delta v_x/x_x$')
plt.ylabel(r'$\delta v_y/v_y$')
plt.ylim(10**-4,10**4)
plt.xlim(10**-4, 10**1)
